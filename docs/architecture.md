# GHOST-EndpointPosture Architecture

## Overview
`GHOST-EndpointPosture` is built under the Ghost-SY1 v4.0-PRO standard. It operates locally on operator-provided files or directories, calculates SHA-256 evidence hashes, evaluates security rule sets, and outputs structured audit data.
