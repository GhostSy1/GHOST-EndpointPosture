...
TOOL = "GHOST-EndpointPosture"
VERSION = "3.0-PRO"
PROFILE = "Endpoint security posture and hardening reviewer"
RULES = [('EP-PROTECT', 'firewall|antivirus|edr|defender'), ('EP-CRYPTO', 'bitlocker|disk encryption|secure boot|luks'), ('EP-PRIV', 'administrator|root|local admin|screen lock')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-EndpointPosture v3.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
